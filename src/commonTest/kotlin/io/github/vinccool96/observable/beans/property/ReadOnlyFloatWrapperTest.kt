...
class ReadOnlyFloatWrapperTest {
    ...
    fun testToString() {
        ...
        assertEquals("ReadOnlyFloatProperty [bean: $bean, name: My name, value: 0.0]",
        ...
        assertEquals("ReadOnlyFloatProperty [bean: $bean, value: 0.0]", v3.readOnlyProperty.toString())

        val v4 = ReadOnlyFloatWrapper(null, name, DEFAULT)
        assertEquals("FloatProperty [name: My name, value: 0.0]", v4.toString())
        assertEquals("ReadOnlyFloatProperty [name: My name, value: 0.0]", v4.readOnlyProperty.toString())
    }
