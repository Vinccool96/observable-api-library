...
class ReadOnlyStringWrapperTest {
    ...
    fun testToString() {
        ...
        this.property.set(VALUE_1)
        assertEquals("StringProperty [value: $VALUE_1]", this.property.toString())
        ...
        assertEquals("ReadOnlyStringProperty [value: $VALUE_1]", this.readOnlyProperty.toString())
        this.property.get()
        assertEquals("StringProperty [bound, value: $VALUE_1]", this.property.toString())
        assertEquals("ReadOnlyStringProperty [value: $VALUE_1]", this.readOnlyProperty.toString())
        v1.set(VALUE_2)
        assertEquals("StringProperty [bound, invalid]", this.property.toString())
        assertEquals("ReadOnlyStringProperty [value: $VALUE_2]", this.readOnlyProperty.toString())
        this.property.get()
        assertEquals("StringProperty [bound, value: $VALUE_2]", this.property.toString())
        assertEquals("ReadOnlyStringProperty [value: $VALUE_2]", this.readOnlyProperty.toString())
