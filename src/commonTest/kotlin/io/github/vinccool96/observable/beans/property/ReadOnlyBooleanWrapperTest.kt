...
class ReadOnlyBooleanWrapperTest {
    ...
    fun testToString() {
        ...
        this.property.set(VALUE_1)
        assertEquals("BooleanProperty [value: $VALUE_1]", this.property.toString())
        ...
        assertEquals("ReadOnlyBooleanProperty [value: $VALUE_1]", this.readOnlyProperty.toString())
        this.property.get()
        assertEquals("BooleanProperty [bound, value: $VALUE_1]", this.property.toString())
        assertEquals("ReadOnlyBooleanProperty [value: $VALUE_1]", this.readOnlyProperty.toString())
        v1.set(VALUE_2)
        assertEquals("BooleanProperty [bound, invalid]", this.property.toString())
        assertEquals("ReadOnlyBooleanProperty [value: $VALUE_2]", this.readOnlyProperty.toString())
        this.property.get()
        assertEquals("BooleanProperty [bound, value: $VALUE_2]", this.property.toString())
        assertEquals("ReadOnlyBooleanProperty [value: $VALUE_2]", this.readOnlyProperty.toString())
