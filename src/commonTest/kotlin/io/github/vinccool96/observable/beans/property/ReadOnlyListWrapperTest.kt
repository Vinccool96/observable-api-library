...
import io.github.vinccool96.observable.collections.MockListObserver
...
class ReadOnlyListWrapperTest {
    ...
    fun testToString() {
        ...
        this.property.set(VALUE_1)
        assertEquals("ListProperty [value: $VALUE_1]", this.property.toString())
        assertEquals("ReadOnlyListProperty [value: $VALUE_1]", this.readOnlyProperty.toString())

        this.property.bind(v1)
        assertEquals("ListProperty [bound, invalid]", this.property.toString())
        assertEquals("ReadOnlyListProperty [value: $VALUE_1]", this.readOnlyProperty.toString())
        this.property.get()
        assertEquals("ListProperty [bound, value: $VALUE_1]", this.property.toString())
        assertEquals("ReadOnlyListProperty [value: $VALUE_1]", this.readOnlyProperty.toString())
        v1.set(VALUE_2)
        assertEquals("ListProperty [bound, invalid]", this.property.toString())
        assertEquals("ReadOnlyListProperty [value: ${VALUE_2}]", this.readOnlyProperty.toString())
        this.property.get()
        assertEquals("ListProperty [bound, value: ${VALUE_2}]", this.property.toString())
        assertEquals("ReadOnlyListProperty [value: ${VALUE_2}]", this.readOnlyProperty.toString())
