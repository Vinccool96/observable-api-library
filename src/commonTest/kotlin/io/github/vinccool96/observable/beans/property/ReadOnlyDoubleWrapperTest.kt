...
class ReadOnlyDoubleWrapperTest {
    ...
    fun testToString() {
        ...
        assertEquals("DoubleProperty [bean: $bean, name: My name, value: 0.0]", v2.toString())
        assertEquals("ReadOnlyDoubleProperty [bean: $bean, name: My name, value: 0.0]",
        ...
        assertEquals("ReadOnlyDoubleProperty [bean: $bean, value: 0.0]", v3.readOnlyProperty.toString())

        val v4 = ReadOnlyDoubleWrapper(null, name, DEFAULT)
        assertEquals("DoubleProperty [name: My name, value: 0.0]", v4.toString())
        assertEquals("ReadOnlyDoubleProperty [name: My name, value: 0.0]", v4.readOnlyProperty.toString())
    }
