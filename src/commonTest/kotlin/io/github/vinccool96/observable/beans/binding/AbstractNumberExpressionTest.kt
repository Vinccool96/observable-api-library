...
abstract class AbstractNumberExpressionTest {
    ...
    fun testFactory() {
        ...
        assertEquals(ObservableCollections.singletonObservableList<Observable>(double2), exp.dependencies)
        ...
        assertEquals(ObservableCollections.singletonObservableList<Observable>(float2), exp.dependencies)
        ...
        assertEquals(ObservableCollections.singletonObservableList<Observable>(long2), exp.dependencies)
        ...
        assertEquals(ObservableCollections.singletonObservableList<Observable>(int2), exp.dependencies)
        ...
        assertEquals(ObservableCollections.singletonObservableList<Observable>(short2), exp.dependencies)
    ...
    fun testFactoryOther() {
        assertFailsWith<IllegalArgumentException> { NumberExpressionBase.numberExpression(OtherNumberValue()) }
    }
