...
class DoublePropertyTest {
    ...
    fun testToString() {
        ...
        assertEquals("DoubleProperty [value: 0.0]", v0.toString())

        val v1: DoubleProperty = DoublePropertyStub(NO_BEAN, NO_NAME_2)
        assertEquals("DoubleProperty [value: 0.0]", v1.toString())
        ...
        assertEquals("DoubleProperty [bean: $bean, value: 0.0]", v4.toString())
        v4.set(VALUE_1)
        assertEquals("DoubleProperty [bean: $bean, value: $VALUE_1]", v4.toString())

        val v5: DoubleProperty = DoublePropertyStub(NO_BEAN, name)
        assertEquals("DoubleProperty [name: My name, value: 0.0]", v5.toString())
        v5.set(VALUE_1)
