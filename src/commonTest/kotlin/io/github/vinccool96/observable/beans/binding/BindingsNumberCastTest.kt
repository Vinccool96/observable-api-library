...
abstract class BindingsNumberCastTest {

    protected abstract val func: Functions
...
class BindingsNumberCastTest_Add : BindingsNumberCastTest() {

    override val func: Functions = object : Functions {

        override fun generateExpression(op1: ObservableNumberValue, op2: ObservableNumberValue): Binding<*> {
...
class BindingsNumberCastTest_Multiply : BindingsNumberCastTest() {
...
class BindingsNumberCastTest_Divide : BindingsNumberCastTest() {
...
class BindingsNumberCastTest_Min : BindingsNumberCastTest() {
...
class BindingsNumberCastTest_Max : BindingsNumberCastTest() {
...
class BindingsNumberCastTest_Equal : BindingsNumberCastTest() {
...
class BindingsNumberCastTest_GreaterThan : BindingsNumberCastTest() {
