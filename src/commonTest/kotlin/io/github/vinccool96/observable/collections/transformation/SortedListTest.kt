...
import io.github.vinccool96.observable.collections.*
import io.github.vinccool96.observable.dev.Callback
import io.github.vinccool96.observable.dev.Compare
...
class SortedListTest {
    ...
    fun testMutableElementSortedFilteredChain() {
        ...
        val sorted: SortedList<Person> = filtered.sorted(Compare.comparing { t: Person -> t.name.valueSafe })
