...
abstract class ObservableListTest(private val listFactory: Callable<ObservableList<String?>>) {
...
class ObservableListTest0 : ObservableListTest(TestedObservableLists.ARRAY_LIST)

class ObservableListTest1 : ObservableListTest(TestedObservableLists.LINKED_LIST)

class ObservableListTest2 : ObservableListTest(TestedObservableLists.OBSERVABLE_LIST_PROPERTY)