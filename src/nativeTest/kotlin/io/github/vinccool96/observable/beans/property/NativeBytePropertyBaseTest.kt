...
import io.github.vinccool96.observable.beans.value.ObservableByteValueStub
...
class NativeBytePropertyBaseTest {

    private val v = ObservableByteValueStub(VALUE_1)
    ...
    private class BytePropertyMock(override val bean: Any?, override val name: String?) :
            BytePropertyBase(VALUE_1) {
    ...
    companion object {
        ...
        private const val VALUE_2: Byte = 42
