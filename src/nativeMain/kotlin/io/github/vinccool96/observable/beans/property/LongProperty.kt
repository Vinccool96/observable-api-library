...
actual abstract class LongProperty : ReadOnlyLongProperty(), Property<Number?>, WritableLongValue {
     ...
     */
    actual override fun asObject(): ObjectProperty<Long> {
    ...
    actual companion object {
         ...
         */
        actual fun longProperty(property: Property<Long?>): LongProperty {
