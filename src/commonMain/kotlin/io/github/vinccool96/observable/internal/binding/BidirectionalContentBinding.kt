...
internal object BidirectionalContentBinding {
    ...
    private class ListContentBinding<E>(list1: ObservableList<E>, list2: ObservableList<E>) : ListChangeListener<E>,
        ...
        private val propertyRef1: WeakReference<ObservableList<E>> = WeakReferenceFactory.createWeakRef(list1)

        private val propertyRef2: WeakReference<ObservableList<E>> = WeakReferenceFactory.createWeakRef(list2)
        ...
        override fun clear() {
            this.propertyRef1.clear()
            this.propertyRef2.clear()
        }
