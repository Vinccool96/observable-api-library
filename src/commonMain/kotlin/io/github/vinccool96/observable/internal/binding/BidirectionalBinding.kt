...
abstract class BidirectionalBinding<T>(property1: Any, property2: Any) : ChangeListener<T>, WeakListener {
    ...
    override fun clear() {
        if (this.property1 is Property<*>?) {
            (this.property1 as Property<T>?)?.removeListener(this)
        }
        if (this.property2 is Property<*>?) {
            (this.property2 as Property<T>?)?.removeListener(this)
        }
    }
    ...
    private class BidirectionalBooleanBinding(property1: BooleanProperty, property2: BooleanProperty) :
        ...
        private val propertyRef1: WeakReference<BooleanProperty> = WeakReferenceFactory.createWeakRef(property1)

        private val propertyRef2: WeakReference<BooleanProperty> = WeakReferenceFactory.createWeakRef(property2)
    ...
    private class BidirectionalDoubleBinding(property1: DoubleProperty, property2: DoubleProperty) :
        ...
        private val propertyRef1: WeakReference<DoubleProperty> = WeakReferenceFactory.createWeakRef(property1)

        private val propertyRef2: WeakReference<DoubleProperty> = WeakReferenceFactory.createWeakRef(property2)
    ...
    private class BidirectionalFloatBinding(property1: FloatProperty, property2: FloatProperty) :
        ...
        private val propertyRef1: WeakReference<FloatProperty> = WeakReferenceFactory.createWeakRef(property1)

        private val propertyRef2: WeakReference<FloatProperty> = WeakReferenceFactory.createWeakRef(property2)
    ...
    private class BidirectionalLongBinding(property1: LongProperty, property2: LongProperty) :
        ...
        private val propertyRef1: WeakReference<LongProperty> = WeakReferenceFactory.createWeakRef(property1)

        private val propertyRef2: WeakReference<LongProperty> = WeakReferenceFactory.createWeakRef(property2)
    ...
    private class BidirectionalIntBinding(property1: IntProperty, property2: IntProperty) :
        ...
        private val propertyRef1: WeakReference<IntProperty> = WeakReferenceFactory.createWeakRef(property1)

        private val propertyRef2: WeakReference<IntProperty> = WeakReferenceFactory.createWeakRef(property2)
    ...
    private class TypedGenericBidirectionalBinding<T>(property1: Property<T>, property2: Property<T>) :
        ...
        private val propertyRef1: WeakReference<Property<T>> = WeakReferenceFactory.createWeakRef(property1)

        private val propertyRef2: WeakReference<Property<T>> = WeakReferenceFactory.createWeakRef(property2)
    ...
    private class TypedNumberBidirectionalBinding<T : Number>(property1: Property<T>, property2: Property<Number?>) :
        ...
        private val propertyRef2: WeakReference<Property<Number?>> = WeakReferenceFactory.createWeakRef(property2)
    ...
    abstract class StringConversionBidirectionalBinding<T>(stringProperty: Property<String?>,
        ...
        private val stringPropertyRef: WeakReference<Property<String?>> =
                WeakReferenceFactory.createWeakRef(stringProperty)

        private val otherPropertyRef: WeakReference<Property<T>> = WeakReferenceFactory.createWeakRef(otherProperty)
    ...
    companion object {
        ...
        internal fun checkParameters(property1: Any, property2: Any) {
