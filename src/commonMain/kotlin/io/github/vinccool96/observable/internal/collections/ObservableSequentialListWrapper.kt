...
class ObservableSequentialListWrapper<E>(list: MutableList<E>) : ModifiableObservableListBase<E>(), ObservableList<E>,
        SortableList<E> {

    private val backingList: MutableList<E> = list

    private var elementObserver: ElementObserver<E>? = null
