 ...
 * style.
 *
 * A concrete subclass of `IntExpression` has to implement the method [get], which provides the actual value of this
 * expression.
 */
abstract class IntExpression : NumberExpressionBase(), ObservableIntValue {
    ...
    companion object {
         ...
         * [io.github.vinccool96.observable.beans.property.ObjectProperty] of specific number type to
