...
interface Binding<T> : ObservableValue<T> {
    ...
    val dependencies: ObservableList<Observable>
     ...
     *
     * All bindings in our implementation use instances of [io.github.vinccool96.observable.beans.WeakInvalidationListener],
