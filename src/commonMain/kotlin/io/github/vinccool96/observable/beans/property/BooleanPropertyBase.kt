...
import io.github.vinccool96.observable.beans.binding.BooleanBinding
...
abstract class BooleanPropertyBase(initialValue: Boolean) : BooleanProperty() {
    ...
    private class Listener(ref: BooleanPropertyBase) : InvalidationListener {
        ...
        private val wRef: WeakReference<BooleanPropertyBase> = WeakReferenceFactory.createWeakRef(ref)
