...
import io.github.vinccool96.observable.beans.property.ReadOnlyBooleanPropertyBase
import io.github.vinccool96.observable.beans.property.ReadOnlyIntProperty
import io.github.vinccool96.observable.beans.property.ReadOnlyIntPropertyBase
...
abstract class ListBinding<E> : ListExpression<E>(), Binding<ObservableList<E>?> {
    ...
    private fun invalidateProperties() {
        if (this::size0.isInitialized) {
            (this.sizeProperty as ListBinding<E>.SizeProperty).fireValueChangedEvent()
        }
        if (this::empty0.isInitialized) {
            (this.emptyProperty as ListBinding<E>.EmptyProperty).fireValueChangedEvent()
        }
    }
