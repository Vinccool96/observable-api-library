...
import io.github.vinccool96.observable.beans.binding.DoubleBinding
...
abstract class DoublePropertyBase(initialValue: Double) : DoubleProperty() {
    ...
    override fun toString(): String {
        ...
        if (this.bound) {
            ...
            if (this.valid) {
                val v = get()
                result.append("value: ").append(if (v == 0.0) "0.0" else v.toString())
            } else {
    ...
    private class Listener(ref: DoublePropertyBase) : InvalidationListener {
        ...
        private val wRef: WeakReference<DoublePropertyBase> = WeakReferenceFactory.createWeakRef(ref)
