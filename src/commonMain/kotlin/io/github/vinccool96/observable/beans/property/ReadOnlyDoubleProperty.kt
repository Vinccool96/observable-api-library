...
import io.github.vinccool96.observable.beans.WeakInvalidationListener
import io.github.vinccool96.observable.beans.binding.DoubleExpression
...
abstract class ReadOnlyDoubleProperty : DoubleExpression(), ReadOnlyProperty<Number?> {
    ...
    override fun toString(): String {
        ...
        val v: Double = get()
        result.append("value: ").append(if (v == 0.0) "0.0" else "$v").append("]")
