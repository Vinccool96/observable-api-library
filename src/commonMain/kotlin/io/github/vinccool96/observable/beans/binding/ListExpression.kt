...
import io.github.vinccool96.observable.beans.property.ReadOnlyBooleanProperty
import io.github.vinccool96.observable.beans.property.ReadOnlyIntProperty
import io.github.vinccool96.observable.beans.value.ObservableIntValue
import io.github.vinccool96.observable.beans.value.ObservableListValue
 ...
 * style.
 *
 * A concrete subclass of `ListExpression` has to implement the method [get], which provides the actual value of this
 * expression.
 *
        ...
        fun <E> listExpression(value: ObservableListValue<E>): ListExpression<E> {
            return if (value is ListExpression<E>) value else object : ListBinding<E>() {
                ...
                override val dependencies: ObservableList<Observable> =
                        ObservableCollections.singletonObservableList(value)
