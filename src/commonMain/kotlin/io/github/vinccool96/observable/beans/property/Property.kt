...
import io.github.vinccool96.observable.beans.value.WritableValue
...
interface Property<T> : ReadOnlyProperty<T>, WritableValue<T> {
     ...
     *
     * Note that the API has all the bind calls implemented through weak listeners. This means the bound property can be
     ...
     *
     * The API bidirectional binding implementation use weak listeners. This means bidirectional binding does not
     * prevent properties from being garbage collected.
     *
