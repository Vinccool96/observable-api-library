...
import io.github.vinccool96.observable.collections.WeakListChangeListener
 ...
 *
 * @property source Contains the source list of this transformation list. This is never null and should be used to
 * directly access source list content. It is the source list specified in the constructor of this transformation list.
 *
 * @return The List that is directly wrapped by this TransformationList
 *
 */
abstract class TransformationList<E, F>(val source: ObservableList<out F>) : ObservableListBase<E>(),
        ObservableList<E> {
