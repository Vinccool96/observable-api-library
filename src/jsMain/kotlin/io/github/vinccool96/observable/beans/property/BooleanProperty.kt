...
actual abstract class BooleanProperty : ReadOnlyBooleanProperty(), Property<Boolean?>, WritableBooleanValue {

    actual override var value: Boolean?
        get() = this.get()
        set(value) {
            if (value == null) {
    ...
    actual override fun bindBidirectional(other: Property<Boolean?>) {
        Bindings.bindBidirectional(this, other)
    }

    actual override fun unbindBidirectional(other: Property<Boolean?>) {
     ...
     */
    actual override fun asObject(): ObjectProperty<Boolean> {
    ...
    actual companion object {
         ...
         */
        actual fun booleanProperty(property: Property<Boolean?>): BooleanProperty {
